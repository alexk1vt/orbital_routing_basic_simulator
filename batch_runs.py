...
disruption_option_duration = "10"#"600" # 10 hours
...
disruption_location_list = ["Puerto_Villamil", "Tres_Lagos", "Shelby"] #NS_new_world
#disruption_intensity_list = ["25", "75"]
disruption_intensity_list = ["25", "75", "100"]
    ...
    for packet_schedule_arg in packet_schedule_list:
        for disruption_schedule_arg in disruption_schedule_list:
            if disruption_schedule_arg == no_disruption_schedule:
                ...
                # Output path
                if systemOS == 'Linux':
                    path = "/home/alex/repos/orbital_routing_basic_simulator/" + series_name + "/"
                    output_path = path + "outputs/" + routing_method_arg.replace(" ", "_") + "/"
                elif systemOS == 'Windows':
                    path = "C:\\Users\\xande\\source\\repos\\orbital_routing_basic_simulator\\" + series_name + "\\"
                    output_path = path + "outputs\\" + routing_method_arg.replace(" ", "_") + "\\"
